...
export default {
  setup() {
    ...
    const taxaLocalidade = ref([
      ...
      { nome: "Brotolândia", preco: "3.00" },
      { nome: "São Raimundo", preco: "3.00" },
      { nome: "Estrada das Flores", preco: "3.00" },
      { nome: "Centro", preco: "3.00" },
      { nome: "Sítio Ilha", preco: "3.00" },
      { nome: "João 23", preco: "3.00" },
      { nome: "Limoeirinho", preco: "3.00" },
      { nome: "Populares", preco: "3.00" },
      { nome: "Eucaliptos", preco: "3.00" },
      { nome: "Santa Luzia", preco: "3.00" },
      { nome: "Sítio Socorro", preco: "3.00" },
      { nome: "Sítio Milagres", preco: "3.00" },
      { nome: "Conviver", preco: "3.00" },
      { nome: "Cidade Alta", preco: "3.00" },
      { nome: "Bom Fim", preco: "3.00" },
      { nome: "Arraial", preco: "3.00" },
      { nome: "Várzea do Cobra", preco: "3.00" },
      { nome: "Hospital Regional", preco: "3.00" },
    ]);
    ...
    function finalizarPedido() {
      ...
      if (this.carrinho.dadosPessoais.formaDeEntrega == "Vou buscar") {
        if (this.carrinho.dadosPessoais.nome != "") {
          ...
          window.location.href = `https://wa.me/5588921679493?text=${this.pedidoMontado}`;
        } else {
